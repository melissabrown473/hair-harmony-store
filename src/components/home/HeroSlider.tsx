...
const heroSlides = [
  { kicker: "Premium Hair Boutique", title: "Look Great with", accent: "Extensions", desc: "100% Remy human hair, hand-tied and tangle free. Length, volume and shine — on demand.", img: heroModel, cta: "Shop Extensions" },
  { kicker: "HD Lace Collection", title: "Wigs that feel", accent: "invisible", desc: "Glueless, pre-plucked HD lace wigs in every texture — ready to wear straight out of the box.", img: program3, cta: "Shop Wigs" },
  { kicker: "Little details, big impact", title: "Luxury Hair", accent: "Accessories", desc: "Pearl pins, gilded combs, silk scrunchies and bridal tiaras — the finishing touch on any look.", img: accessoriesImg, cta: "Shop Accessories" },
  { kicker: "Every strand matters", title: "Salon-grade", accent: "Hair Care", desc: "Argan, keratin and botanical formulas that restore shine and strengthen from root to tip.", img: mission1, cta: "Shop Hair Care" },
  { kicker: "New Season Edit", title: "Curls that", accent: "bounce back", desc: "Defined, moisture-locked curls and coils — extensions and wigs styled for natural texture.", img: program2, cta: "Explore Collection" },
];
