...
/>
        ...
        <div className="relative mx-auto flex min-h-[650px] max-w-7xl items-center px-6">
          ...
          <div className="max-w-2xl">
            ...
            <p className="text-xs uppercase tracking-[0.45em] text-[#caa15b]">
              About Hair Harmony
            </p>
            ...
            <p className="mt-8 max-w-lg text-lg leading-8 text-white/70">
              We create luxury hair collections designed to enhance confidence,
              celebrate individuality, and deliver timeless beauty.
            </p>
...
/>
            ...
            <div className="absolute bottom-10 left-1/2 -translate-x-1/2 rounded-xl bg-white px-8 py-5 text-center shadow-xl">
              ...
              <p className="font-display text-3xl text-[#caa15b]">
                10k+
              </p>
          ...
          <div>
            ...
            <p className="mt-8 text-lg leading-9 text-muted-foreground">
              Hair Harmony was founded on a simple belief: everyone deserves
              hair they love. Every collection is carefully selected,
              ethically sourced, and inspected to ensure premium quality.
            </p>


            <p className="mt-5 text-lg leading-9 text-muted-foreground">
              From luxury extensions to timeless accessories, every piece is
              created to help you express your unique beauty.
            </p>
